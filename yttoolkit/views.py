    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if created:
                ...
                messages.success(request, f'Download started successfully! Task ID: {task.id}')
            else:
                if youtube_mp3.download_status in ['completed', 'in_progress']:
                    messages.warning(request, 'This video is already downloaded or currently downloading')
                else:
